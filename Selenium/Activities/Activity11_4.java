...
public class Activity11_4 {
    public static void main(String[] args) throws InterruptedException {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@target='_blank']")));
        String newTabText = driver.findElement(By.xpath("//a[@target='_blank']")).getText();
